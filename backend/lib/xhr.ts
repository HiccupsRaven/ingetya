import { IAny, IResponse } from "../types/LibTypes"
...
const xhr = {
  async get(ref: string, authorization?: string | null): Promise<IResponse> {
    return await efetch("GET", ref, authorization)
  },
  async post(ref: string, authorization?: string | null, s?: IAny): Promise<IResponse> {

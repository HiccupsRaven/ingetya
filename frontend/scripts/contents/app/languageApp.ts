import lang_id from "../../../locales/id/app_id.json"
import lang_en from "../../../locales/en/app_en.json"
import { kel } from "../../lib/kel"
import modal from "../../lib/modal"
import { getLanguage, saveLocale, setLanguage } from "../../lib/locales"
...
export async function changeLang(): Promise<boolean> {
  ...
  if (optLang === updatedLang) return false
